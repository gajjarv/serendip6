...
#		out = plt.scatter(x,y,c=z,s=3, alpha=0.5, edgecolors='none',vmin=z.min(),vmax=z.max(),cmap=cm)
		out = plt.scatter(x,y,c=z,s=3, edgecolors='none',vmin=z.min(),vmax=z.max(),cmap=cm)
...
#		col = [cm(float(i)/(len(z))) for i in xrange(len(z))]
#		ax3D = fig.add_subplot(111, projection='3d')
#		ax3D.scatter(x, y, z, s=80, c=col, marker='o')  
#		im = plt.scatter(x,y,s=80,c=z, marker=(5, 2))
#		im = plt.contourf(x,y,z,aspect='auto')
